...
void fromRC100(OpenManipulator* open_manipulator, uint16_t data)
{
  ...
  if (!(data & RC100_BTN_6)) {
    if (data & RC100_BTN_L){
      ...
      goal_position.push_back(5*  DEG2RAD);
      goal_position.push_back(0 * DEG2RAD);
      goal_position.push_back(0 * DEG2RAD);
      goal_position.push_back(0 * DEG2RAD);
      open_manipulator->makeJointTrajectoryFromPresentPosition(goal_position, 0.2);
    }
    ...
    else if (data & RC100_BTN_5)
    {
      ...
      goal_position.push_back(0 * DEG2RAD);
      goal_position.push_back(0 * DEG2RAD);
      goal_position.push_back(0.0 * DEG2RAD);
